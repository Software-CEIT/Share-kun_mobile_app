...
mixin _$CreateBankAccountRequestModel {
 ...
 String get bank; String get accountNumber; String get holderName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateBankAccountRequestModel&&(identical(other.bank, bank) || other.bank == bank)&&(identical(other.accountNumber, accountNumber) || other.accountNumber == accountNumber)&&(identical(other.holderName, holderName) || other.holderName == holderName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,bank,accountNumber,holderName);

@override
String toString() {
  return 'CreateBankAccountRequestModel(bank: $bank, accountNumber: $accountNumber, holderName: $holderName)';
}
...
@useResult
$Res call({
 String bank, String accountNumber, String holderName
});
...
/// Create a copy of CreateBankAccountRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bank = null,Object? accountNumber = null,Object? holderName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String bank,  String accountNumber,  String holderName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateBankAccountRequestModel() when $default != null:
return $default(_that.bank,_that.accountNumber,_that.holderName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String bank,  String accountNumber,  String holderName)  $default,) {final _that = this;
switch (_that) {
case _CreateBankAccountRequestModel():
return $default(_that.bank,_that.accountNumber,_that.holderName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String bank,  String accountNumber,  String holderName)?  $default,) {final _that = this;
switch (_that) {
case _CreateBankAccountRequestModel() when $default != null:
return $default(_that.bank,_that.accountNumber,_that.holderName);case _:
  return null;
...
class _CreateBankAccountRequestModel implements CreateBankAccountRequestModel {
  const _CreateBankAccountRequestModel({required this.bank, required this.accountNumber, required this.holderName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateBankAccountRequestModel&&(identical(other.bank, bank) || other.bank == bank)&&(identical(other.accountNumber, accountNumber) || other.accountNumber == accountNumber)&&(identical(other.holderName, holderName) || other.holderName == holderName));
}
...
/// Create a copy of CreateBankAccountRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bank = null,Object? accountNumber = null,Object? holderName = null,}) {
