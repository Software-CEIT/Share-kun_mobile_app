...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContactModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
class _ContactModel implements ContactModel {
  const _ContactModel({required this.id, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContactModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
/// @nodoc
mixin _$ContactListResponseModel {

 List<ContactModel> get contacts;
/// Create a copy of ContactListResponseModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ContactListResponseModelCopyWith<ContactListResponseModel> get copyWith => _$ContactListResponseModelCopyWithImpl<ContactListResponseModel>(this as ContactListResponseModel, _$identity);

  /// Serializes this ContactListResponseModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContactListResponseModel&&const DeepCollectionEquality().equals(other.contacts, contacts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(contacts));

@override
String toString() {
  return 'ContactListResponseModel(contacts: $contacts)';
}
...
/// @nodoc
abstract mixin class $ContactListResponseModelCopyWith<$Res>  {
  factory $ContactListResponseModelCopyWith(ContactListResponseModel value, $Res Function(ContactListResponseModel) _then) = _$ContactListResponseModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ContactListResponseModelCopyWithImpl<$Res>
    implements $ContactListResponseModelCopyWith<$Res> {
  _$ContactListResponseModelCopyWithImpl(this._self, this._then);

  final ContactListResponseModel _self;
  final $Res Function(ContactListResponseModel) _then;

/// Create a copy of ContactListResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? contacts = null,}) {
  return _then(_self.copyWith(
...
/// Adds pattern-matching-related methods to [ContactListResponseModel].
extension ContactListResponseModelPatterns on ContactListResponseModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ContactListResponseModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ContactListResponseModel() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ContactListResponseModel value)  $default,){
final _that = this;
switch (_that) {
case _ContactListResponseModel():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ContactListResponseModel value)?  $default,){
final _that = this;
switch (_that) {
case _ContactListResponseModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ContactModel> contacts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContactListResponseModel() when $default != null:
return $default(_that.contacts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ContactModel> contacts)  $default,) {final _that = this;
switch (_that) {
case _ContactListResponseModel():
return $default(_that.contacts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ContactModel> contacts)?  $default,) {final _that = this;
switch (_that) {
case _ContactListResponseModel() when $default != null:
return $default(_that.contacts);case _:
  return null;
...
class _ContactListResponseModel implements ContactListResponseModel {
  const _ContactListResponseModel({required final  List<ContactModel> contacts}): _contacts = contacts;
  factory _ContactListResponseModel.fromJson(Map<String, dynamic> json) => _$ContactListResponseModelFromJson(json);

 final  List<ContactModel> _contacts;
@override List<ContactModel> get contacts {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ContactListResponseModelCopyWith<_ContactListResponseModel> get copyWith => __$ContactListResponseModelCopyWithImpl<_ContactListResponseModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ContactListResponseModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContactListResponseModel&&const DeepCollectionEquality().equals(other._contacts, _contacts));
}
...
/// @nodoc
abstract mixin class _$ContactListResponseModelCopyWith<$Res> implements $ContactListResponseModelCopyWith<$Res> {
  factory _$ContactListResponseModelCopyWith(_ContactListResponseModel value, $Res Function(_ContactListResponseModel) _then) = __$ContactListResponseModelCopyWithImpl;
@override @useResult
$Res call({
 List<ContactModel> contacts
});
...
/// @nodoc
class __$ContactListResponseModelCopyWithImpl<$Res>
    implements _$ContactListResponseModelCopyWith<$Res> {
  __$ContactListResponseModelCopyWithImpl(this._self, this._then);

  final _ContactListResponseModel _self;
  final $Res Function(_ContactListResponseModel) _then;

/// Create a copy of ContactListResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? contacts = null,}) {
  return _then(_ContactListResponseModel(
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateContactRequestModel&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'CreateContactRequestModel(name: $name)';
}
...
class _CreateContactRequestModel implements CreateContactRequestModel {
  const _CreateContactRequestModel({required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateContactRequestModel&&(identical(other.name, name) || other.name == name));
}
