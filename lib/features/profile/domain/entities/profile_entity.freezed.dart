...
@override
String toString() {
  return 'ProfileEntity(id: $id, name: $name, phone: $phone, avatar: $avatar, memberSince: $memberSince, language: $language)';
}
...
class _ProfileEntity implements ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.phone, this.avatar, required this.memberSince, required this.language});
